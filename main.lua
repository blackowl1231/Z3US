...
local BloxstrikeVersionBtn = L_1_["1a"]
local rivalsAutoloadBtn = L_1_["2e"]
local rivalsSilentloadBtn = L_1_["33"]
local rivalsVersionBtn = L_1_["3d"]
local BloxstrikeOptionsFrame = L_1_["13"]
local rivalsOptionsFrame = L_1_["27"]
local overkillKeyFrame = L_1_["44"]
local overkillKeyBox = L_1_["47"]

local selectedGame,selectedStroke,BloxstrikeVersion,rivalsAutoload, rivalsSilentload, rivalsVersion, overkillKey = "", nil, "Old", true, false, "V2", ""
function kys()
    pcall(function()
    ...
    if textLabel then
        textLabel.InputBegan:Connect(function(input)
            if input.UserInputType == Enum.UserInputType.MouseButton1 then
                ...
                --BloxstrikeOptionsFrame.Visible = (gameName == "Bloxstrike")
...
BloxstrikeVersionBtn.MouseButton1Click:Connect(function()
    if BloxstrikeVersionBtn.Text == "Old" then
        BloxstrikeVersionBtn.Text = "New"
        BloxstrikeVersion = "New"
    else
        BloxstrikeVersionBtn.Text = "Old"
        BloxstrikeVersion = "Old"
    end
end)
...
loadBtn.MouseButton1Click:Connect(function()
    ...
    elseif selectedGame == "Bloxstrike" then
        getgenv().SCRIPT_KEY = ""
